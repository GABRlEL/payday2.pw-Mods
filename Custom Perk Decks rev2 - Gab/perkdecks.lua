...
data(self, tweak_data)
	...
	self.values.player.extra_ammo_multiplier = {1.25, 3.5}
	
	self.values.player.increased_pickup_area = {1.5, 3}
	
	self.values.player.movement_speed_multiplier = {1, 0.74, 1, 1.5}
	...
	self.values.player.melee_sharp_damage_multiplier = {3, 9999}
